...
class OracoesPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      backgroundColor: Color.fromARGB(255, 217, 213, 197), // Definindo a cor de fundo da página
...
class TemaOracaoCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Card(
      ...
      child: ExpansionTile(
        backgroundColor: Color.fromARGB(255, 255, 246, 218), // Alterando a cor de fundo do menu que expande para amarelo
        title: Text(
          tema,
